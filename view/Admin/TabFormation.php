        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <button type="button" class="btn btn-success" ><a href="?op=new" style="color:white;">Ajouter Experience</a></button><br>
              ...
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <?php endforeach;?>
                          <td>
                            <button type="button" class="btn btn-success">
                              <a href="?op=delete&id_formation=<?php echo $formations['id_formation']?>" style="color:white;">
                                Delete
                              </a>
                          </button>
                          </td>
                          <td>
                            <button type="button" class="btn btn-success">
                              <a href="?op=update&id_formation=<?php echo $formations['id_formation']?>" style="color:white;">
                                    Edite
                              </a>
                            </button>
                          </td>
                ...
                if(!empty($_POST)){ // si le formulaire à été validé et qu'il y a des infos dedans
                  ...
                  if(isset($_GET['op']) && $_GET['op'] == 'update') {
                    ...
                    execute_requete("UPDATE formation SET nomFormation='$_POST[nomFormation]',date='$_POST[date]',poste='$_POST[poste]',ville='$_POST[ville]' WHERE id_formation='$_GET[id_formation]'");
              
                    header('location:TabFormation.php');
              
                  }else{

                    execute_requete("INSERT INTO formation(nomFormation, date, poste, ville) VALUES('$_POST[nomEntreprise]','$_POST[date]','$_POST[poste]','$_POST[ville]')");
