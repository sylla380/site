...
<?php $r = execute_requete("SELECT * FROM experiences"); 
// debug($r);?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <?php endforeach;?>
                          <td>
                            <button type="button" class="btn btn-success">
                              <a href="?op=delete&id_experiences=<?php echo $experiences['id_experiences']?>" style="color:white;">
                                Delete
                              </a>
                          </button>
                          </td>
                          <td>
                            <button type="button" class="btn btn-success">
                              <a href="?op=update&id_experiences=<?php echo $experiences['id_experiences']?>" style="color:white;">
                                    Edite
                              </a>
                            </button>
                          </td>
