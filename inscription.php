...
<form method="post">
    ...
    <input type="text" name="pseudo" id="pseudo" class="form-control"><br><br>

    <label for="mdp">Mot de passe</label><br>
    <input type="text" name="mdp" id="mdp" class="form-control"><br><br>
    ...
    <input type="radio" name="sexe" id="sexe" value="m">Homme<br>
    ...
    <input type="text" name="cp" id="cp" class="form-control"><br><br>
